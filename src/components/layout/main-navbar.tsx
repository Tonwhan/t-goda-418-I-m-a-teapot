      ...
      <div className="w-full max-w-[1280px] h-[64px] flex items-center px-6 text-sm border-b border-b-foreground/10">
        ...
        <header className="flex justify-end items-center gap-4 h-16">
          <Show when="signed-out">
            ...
            <SignUpButton>
              <button className="bg-[#005CBD] text-white rounded-[8px] font-semibold text-sm sm:text-sm cursor-pointer w-[138.58px] h-[36px] whitespace-nowrap flex items-center justify-center px-4 py-2">
                Create Account
              </button>
            </SignUpButton>
          </Show>
